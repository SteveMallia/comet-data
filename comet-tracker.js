/* Comet Tracker - Ontario Telescope and Accessories
   ...
   Data: NASA JPL Horizons (public domain), refreshed nightly. */
(function(){
...
var SITES=[
 ...
 {n:"Hamilton",lat:43.2557,lon:-79.8711,b:7},{n:"Barrie",lat:44.3894,lon:-79.6903,b:6},
 {n:"Peterborough",lat:44.3091,lon:-78.3197,b:5},{n:"Ottawa",lat:45.4215,lon:-75.6972,b:7},
 {n:"London",lat:42.9849,lon:-81.2453,b:7},{n:"Sudbury",lat:46.4917,lon:-80.9930,b:5},
 {n:"Torrance Barrens",lat:44.9333,lon:-79.4500,b:3},{n:"Algonquin Park",lat:45.5000,lon:-78.3500,b:2},
 {n:"Manitoulin Island",lat:45.7500,lon:-82.2000,b:3}];
...
// One plain sentence about how hard this is tonight.
function verdictFor(mag){
  if(mag==null)return "Brightness unavailable.";
  var mm=cometAperture(mag),g=gearFor(mm);
  if(mm<=7)   return "Bright enough to see without any equipment.";
  if(mm<=35)  return "An easy binocular target.";
  if(mm<=130) return "Within reach of a small telescope.";
  if(mm<=330) return "A real target: you need aperture and a dark sky.";
  if(mm<=700) return "Difficult. Large telescope, dark sky, patient observer.";
  return "Too faint to see by eye. A camera will still record it.";
}
    ...
    h+='<div class="cmt-row'+(pass?"":" cmt-off")+'" data-id="'+c.id+'" data-open="'+
      ...
      '<div class="cmt-detail">'+
        '<div class="cmt-kpis">'+
          ...
          '<div class="cmt-kpi"><div class="cmt-l">You will need</div><div class="cmt-v cmt-sm">'+
            (g?g.t:"\u2014")+'</div><div class="cmt-d">'+(g?g.s:"")+'</div></div>'+
        ...
        '</div>'+
        '<div class="cmt-alert '+(mm&&mm<=130?"cmt-info":"cmt-warn")+'"><span class="cmt-ic">'+
          (mm&&mm<=130?"i":"!")+'</span><div><b>'+verdictFor(m)+'</b>'+
          (mm?' Roughly '+(mm<25?'25mm':Math.round(mm/10)*10+'mm')+
              ' of aperture from a Bortle '+S.site.b+' sky like '+S.site.n+'.':'')+
...
/* ---- wiring ---- */
var sel=el("cmt-site");
SITES.forEach(function(s,i){var o=document.createElement("option");
  o.value=i;o.textContent=s.n+" — Bortle "+s.b;sel.appendChild(o);});
